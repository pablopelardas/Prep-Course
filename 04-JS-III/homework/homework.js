...
function mesesDelAño(array) {
  ...
  let arr = [];
  array.forEach(element => {
    if (element == 'Enero' || element == 'Marzo' || element == 'Noviembre') arr.push(element);
  })
...
function breakStatement(numero) {
  ...
  if (interrupt) return 'Se interrumpió la ejecución';
  return arr;
}
